...
public class XcLoggerConfigUpdate implements Parcelable {
    ...
    public static final Creator<XcLoggerConfigUpdate> CREATOR = new Creator<XcLoggerConfigUpdate>() {
        @Override public XcLoggerConfigUpdate createFromParcel(Parcel in) { return new XcLoggerConfigUpdate(in); }
        @Override public XcLoggerConfigUpdate[] newArray(int size) { return new XcLoggerConfigUpdate[size]; }
    };

    public boolean hasField(long field) { return (presentFields & field) != 0; }
    public boolean hasChanges() {
        return presentFields != 0 || hasMutation(tagWhitelist) || hasMutation(packageWhitelist)
                || hasMutation(tagBlacklist) || hasMutation(packageBlacklist);
    }
    private static boolean hasMutation(ListMutation value) { return value != null && value.hasOperations(); }
    ...
    public void setTagWhitelist(ListMutation value) { tagWhitelist = value; }
    public ListMutation getPackageWhitelist() { return packageWhitelist; }
    public void setPackageWhitelist(ListMutation value) { packageWhitelist = value; }
    public ListMutation getTagBlacklist() { return tagBlacklist; }
    public void setTagBlacklist(ListMutation value) { tagBlacklist = value; }
    public ListMutation getPackageBlacklist() { return packageBlacklist; }
    public void setPackageBlacklist(ListMutation value) { packageBlacklist = value; }
    ...
    public static class ListMutation implements Parcelable {
        ...
        public ListMutation(boolean replace, List<String> replacement, List<String> additions, List<String> removals) {
        ...
        public static final Creator<ListMutation> CREATOR = new Creator<ListMutation>() {
            @Override public ListMutation createFromParcel(Parcel in) { return new ListMutation(in); }
            @Override public ListMutation[] newArray(int size) { return new ListMutation[size]; }
        };
        private static ArrayList<String> copy(List<String> value) { return value == null ? new ArrayList<>() : new ArrayList<>(value); }
        private static ArrayList<String> readList(Parcel in) {
            ArrayList<String> value = in.createStringArrayList();
        ...
        public boolean hasOperations() { return replace || !additions.isEmpty() || !removals.isEmpty(); }
        @Override public int describeContents() { return 0; }
        @Override public void writeToParcel(Parcel dest, int flags) {
